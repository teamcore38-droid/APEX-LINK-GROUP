export const BUSINESS_INFO = {
  ...
  emails: {
    info: 'info@apexfashion.lk',
    support: 'support@apexfashion.lk',
    orders: 'orders@apexfashion.lk',
    returns: 'returns@apexfashion.lk',
    hello: 'hello@apexfashion.lk',
    sales: 'sales@apexfashion.lk',
    billing: 'billing@apexfashion.lk',
  },
  ...
  dispatchTimeline: '[BUSINESS OWNER TO CONFIRM: dispatch timeline after payment confirmation]',
  deliveryTimeline: '[BUSINESS OWNER TO CONFIRM: standard Sri Lanka delivery estimate]',
  exchangeWindow: '[BUSINESS OWNER TO CONFIRM: exchange window, if exchanges are offered]',
  warrantyTerms: '[BUSINESS OWNER TO CONFIRM: product warranty terms, if any]',
};

export const POLICY_LAST_UPDATED = 'July 22, 2026';

export const policyUpdateNote = `Last updated: ${POLICY_LAST_UPDATED}.`;
