const RouteLoadingScreen = () => (
  <div className="flex min-h-[55vh] items-center justify-center bg-[#fff7ee] px-4">
    <div className="w-full max-w-md rounded-[28px] border border-[#ead6c6] bg-white px-8 py-10 text-center shadow-[0_18px_40px_rgba(53, 26, 17,0.08)]">
